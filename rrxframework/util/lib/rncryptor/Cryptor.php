<?php
namespace rrxframework\util\lib\rncryptor;
...
class Cryptor {
	...
	protected function _generateKey($salt, $password) {
		...
		return self::hash_pbkdf2($this->_settings->pbkdf2->prf, $password, $salt, $this->_settings->pbkdf2->iterations, $this->_settings->pbkdf2->keyLength, true);
	}
	 ...
	 */
	public static function hash_pbkdf2($algorithm, $password, $salt, $count, $key_length = 0, $raw_output = false)
	{
